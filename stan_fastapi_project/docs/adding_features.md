...
Run with: `uv run stan_fastapi_project cmd my-command --name test`
...
# Or use CLI
uv run stan_fastapi_project db migrate -m "Add notifications table"
uv run stan_fastapi_project db upgrade
```
