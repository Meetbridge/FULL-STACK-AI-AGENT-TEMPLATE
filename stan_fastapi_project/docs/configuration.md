...
|----------|---------|-------------|
| `PROJECT_NAME` | `stan_fastapi_project` | Display name for the project |
...
| `POSTGRES_DB` | `stan_fastapi_project` | Database name |
...
| `LOGFIRE_SERVICE_NAME` | `stan_fastapi_project` | Service name in Logfire dashboard |
...
| `S3_RAG_BUCKET` | `stan_fastapi_project-rag` | Bucket name |
...
| `S3_BUCKET` | `stan_fastapi_project` | Bucket name |
