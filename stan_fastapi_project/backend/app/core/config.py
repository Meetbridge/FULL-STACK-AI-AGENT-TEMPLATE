...
class Settings(BaseSettings):
    ...
    # === Project ===
    PROJECT_NAME: str = "stan_fastapi_project"
    ...
    LOGFIRE_SERVICE_NAME: str = "stan_fastapi_project"
    ...
    POSTGRES_DB: str = "stan_fastapi_project"
    ...
    S3_ACCESS_KEY: str = ""
    S3_SECRET_KEY: str = ""
    S3_BUCKET: str = "stan_fastapi_project"
    ...
    S3_RAG_BUCKET: str = "stan_fastapi_project-rag"
