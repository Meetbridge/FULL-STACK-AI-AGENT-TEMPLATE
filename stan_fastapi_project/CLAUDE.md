...
**stan_fastapi_project** - FastAPI application generated with [Full-Stack AI Agent Template](https://github.com/vstorm-co/full-stack-ai-agent-template).
...
# RAG
uv run stan_fastapi_project rag-collections
uv run stan_fastapi_project rag-ingest /path/to/file.pdf --collection docs
uv run stan_fastapi_project rag-search "query" --collection docs
uv run stan_fastapi_project rag-sync-s3 --collection docs

# Sync Sources
uv run stan_fastapi_project cmd rag-sources
uv run stan_fastapi_project cmd rag-source-add
uv run stan_fastapi_project cmd rag-source-sync
```
